...
# Change box color by JS
SONNET_TLR_COLORS = ['black', 'LimeGreen', 'Red', 'Yellow', 'GreenYellow', 'DarkSeaGreen', 'Cyan', 'WhiteSmoke']
...
def visualize_boxes_and_labels_on_image_array(image,
    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if agnostic_mode:
          ...
          box_to_color_map[box] = SONNET_TLR_COLORS[
              classes[i] % len(SONNET_TLR_COLORS)]
  ...
  for box, color in box_to_color_map.items():
    ...
    draw_bounding_box_on_image_array(
        ...
        xmax,
        color=color,
        # color=SONNET_TLR_COLORS[category_index]
